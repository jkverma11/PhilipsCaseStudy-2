...
namespace NDependAnalyzerLib.Tests
{
    [TestClass]
    public class NDepenedAnalyzerUnitTests
    {

        [TestMethod]
        public void Given_UserFilePath_When_ProcessInput_Invoked_Then_ExpectedTo_Return_False()
        {
        IStaticAnalyzers nDependAnalyzer = new NDependAnalyzer("dir", new FakeUtilitiesStub());
        ...
        {
            IStaticAnalyzers nDependAnalyzer = new NDependAnalyzer("", new FakeUtilitiesStub());
            nDependAnalyzer.AnalyzersData = new AnalyzersDataModel { ExePath = "", Name = "", OutputFilePath = "", RuleFilePath = "" };
